/**
 * Project Name:
 * Class Name:com.sioo.aerospike.jedis.java
 * <p>
 * Version     Date         Author
 * -----------------------------------------
 ...
 */
package com.sioo.aerospike.jedis;
...
/**
 * @author HanKeQi
 * @Description  使用lua aerospike 支持Redis操作
 * @date 2019/4/8 1:25 PM
 **/
...
public class RedisClient {
    ...
    public RedisClient(Collection<Host> hosts, String namespace, String set) {
        this();
    ...
    public RedisClient(Collection<Host> hosts, String namespace, String set, final int timeout) {
        this(hosts, namespace, set);
        if (timeout > 0){
            setTimeout(timeout);
        }
    }
    ...
    private void checkUdfRegistration(){
        ...
        if (modules.contains("src/main/udf/redis.lua"))
            return;
        this.asClient.register(null, "redis.lua", "src/main/udf/redis.lua", Language.LUA);
    }
